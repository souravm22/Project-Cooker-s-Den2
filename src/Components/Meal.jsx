...
return (
    <>     <Header/>
        ...
        <div className=" bg-black pt-3 h-[150px] mb-2">
        {
            ...
            .
            <div className=" flex flex-wrap flex-col justify-center my-2 bg-slate-900  items-center py-1">
                <div className=" mt-5">
                <input type="search" placeholder="Search" className=" font-semibold p-2 h-10 my-auto -translate-x-12 sm:w-[300px]  border border-black shadow-md mb-10" onChange={e=> setSearch(e.target.value)} onKeyPress={searchRecipe}/>
                </div>
            </div>
            <div className="flex justify-center my-5 text-black">
                <button className=" mt-4 -translate-x-12 sm:w-[300px] bg-yellow-300 p-1 hover:scale-110 hover:font-semibold rounded-xl" type="button" onClick={()=>{
                    window.scroll({
